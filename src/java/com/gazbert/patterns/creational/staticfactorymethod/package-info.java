 ...
 * <h2>Actors</h2>
 * <ul>
 * <li>Static Factory - an abstract class for defining the types of Product to built, and provides the Client facing
 *                      business method for building Products which doubles up as the 'factory method'.</li>
